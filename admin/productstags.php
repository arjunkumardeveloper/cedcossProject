...
if (isset($_POST['addColor'])) {
    ...
    $addptag = array("pid"=>$pid, "tid"=>$tid); 
    $msg = addProductsTag($addptag);
}
            ...
            <div class="content-box-content">
                        ...
                        foreach ($data as $row) :
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    alt="Edit" /></a> -->
                                    <form action="productstags.php" method="post"
                ...
                <div class="tab-content" id="tab2">
                    <form action="productstags.php" method="post">
                        ...
                        <p>
                            <label>Tag Id</label>
                            <select name="tid" class="small-input">
                                <?php
                                $data = fetchTags();
                                foreach ($data as $row) :
                                    ?>
