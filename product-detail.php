              ...
              <div class="row">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="admin/productImage/<?php echo $data['image']; ?>" class="simpleLens-lens-image"><img src="admin/productImage/<?php echo $data['image']; ?>" class="simpleLens-big-image"></a></div>
                      </div>
                      <div class="simpleLens-thumbnails-container">
                          <a data-big-image="admin/productImage/<?php echo $data['image']; ?>" data-lens-image="admin/productImage/<?php echo $data['image']; ?>" class="simpleLens-thumbnail-wrapper" href="#">
                            <img src="admin/productImage/<?php echo $data['image']; ?>"
                            width="50" height="70">
                          </a>                                    
                          <a data-big-image="admin/productImage/<?php echo $data['image']; ?>" data-lens-image="admin/productImage/<?php echo $data['image']; ?>" class="simpleLens-thumbnail-wrapper" href="#">
                          <img src="admin/productImage/<?php echo $data['image']; ?>"
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <?php// print_r($data); ?>
                      <a href="#" class="aa-color-<?php echo $data['color']; ?>"></a>
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      <p class="aa-prod-category">
                        Category: <a href="#"><?php echo $data['category_id'] ?></a>
                      </p>
                    </div>
